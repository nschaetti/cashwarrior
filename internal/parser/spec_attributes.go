...
var AttributeSpecs = map[string]AttributeSpec{
	...
	"date":            {Name: "date", AllowedShapes: AttributeValueShapeSingle | AttributeValueShapeList | AttributeValueShapeRange, Type: AttributeValueTypeDate, AllowSettable: true},
